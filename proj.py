...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        while True:
            ...
            #frame = cv2.resize(frame, (0,0), fx=1/2.2, fy=1/2.2)    #resize frame (optional)
            frame = cv2.resize(frame, (0,0), fx=1/1.7, fy=1/1.7)    #resize frame (optional)
            #frame = cv2.resize(frame, (0,0), fx=1.2, fy=1.2)    #resize frame (optional)
                ...
                if nrof_faces > 0:
                    ...
                    for i in range(nrof_faces):
                        ...
                        if bb[i][0] <= 0 or bb[i][1] <= 0 or bb[i][2] >= len(frame[0]) or bb[i][3] >= len(frame):
                            ...
                            print(NamesArray)
                            pyexcel.save_as(array=NamesArray, dest_file_name="NamesArray.xlsx")
                            continue
                        ...
                        if best_class_probabilities>0.25: #CCEL
                            ...
                            for H_i in HumanNames:
                                if HumanNames[best_class_indices[0]] == H_i: 
                                    ...
                                    NamesArray[best_class_indices[0]][1]="present"
                        else:
                            cv2.rectangle(frame, (bb[i][0], bb[i][1]), (bb[i][2], bb[i][3]), (0, 255, 0), 2)    #boxing face
...
print(NamesArray)
pyexcel.save_as(array=NamesArray, dest_file_name="NamesArray.csv")